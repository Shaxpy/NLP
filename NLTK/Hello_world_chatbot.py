...
with open('/home/shaxpy/Desktop/tnf.js/static/chatbot.txt','r', encoding='utf8', errors ='ignore') as fin:
    raw = fin.read().lower()
...
def greeting(sentence):
    ...
    for word in sentence.split():
        if word.lower() or word.upper() in GREETING_INPUTS:
...
def response(user_response):
    ...
    req_tfidf = flat[-2]
    if(req_tfidf==0):
        robo_response=user_response+robo_response+"what?Sorry! I don't understand you"
...
flag=True
print("ROBO: My name is Shaxpy. I will answer your queries about Chatbots. If you want to exit, type Bye!")
while(flag==True):
    user_response = input()
